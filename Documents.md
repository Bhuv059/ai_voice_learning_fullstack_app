...
Following the structure of BookSchema also create models for IBookSegment, IVoiceSession typescript,
interfaces.

create models for Book, book-segment, voice-session
create actions for book-->createBook,saveBookSegments, checkBookExists,
api upload route.ts--> upload with  BLOB_READ_WRITE_TOKEN from vercel
------------------------------------------------------------------------------------------------------
